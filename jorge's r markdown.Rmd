...
data9 <- read.csv("Arrests_Local_State_Police.csv")
data10 <- read.csv("Disciplinary_Actions_On_campus.csv")
data11 <- read.csv("Disciplinary_Actions_Student_Housing_Facilities.csv")
data12 <- read.csv("Disciplinary_Actions_Noncampus.csv")
data13 <- read.csv("Disciplinary_Actions_Public_Property.csv")
data14 <- read.csv("Disciplinary_Actions_Reported_by_Local_State_Police.csv") 
